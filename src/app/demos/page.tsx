  ...
  return (
    <main className="bg-gradient-to-br from-blue-50 to-slate-100 dark:from-[#141414] dark:to-[#143927] hero-gradient font-satoshi">
      <section className="container mx-auto px-4 py-12 pt-24">
        <h1 className="text-4xl font-bold mb-2">Demo Projects</h1>
        <p className=" dark:text-gray-400 mb-8 w-full md:max-w-3xl">
          These are some of my demo projects. I felt like showcasing them for
          whatever purpose. While some are still in progress, others are simply
          variations of my failed attempt at success.
        </p>
